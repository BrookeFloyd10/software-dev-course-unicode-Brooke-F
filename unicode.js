...
let codePointFirst = inputString2.charCodeAt(0);
let codePointLast = inputString2.charCodeAt(inputString2.length -1);
let swappedString = 
  String.fromCharCode(codePointLast) +
  inputString2.slice(1, inputString2.length -1) +
  String.fromCharCode(codePointFirst);
